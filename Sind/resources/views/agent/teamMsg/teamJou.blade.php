                    ...
                    <div class="layui-form">
                        <div class="layui-form-item">
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-inline">
                                    <select id="select_status" class="layui-select">
                                        <option value="" <?php if($status == "")echo "selected";?>>全部</option>
                                        @foreach($status_data as $k=>$v)
                                            <option value="{{$v["id"]}}" <?php if($status == $v["id"])echo "selected";?>>{{$v["status_name"]}}</option>
                                        @endforeach
                                    </select>
                                </div>
...
<script>
    layui.use(['form', 'layedit', 'laydate'], function() {
        ...
        $(document).on("click",".kj_time",function () {
            ...
            location.href = "{{url('agent/teamJou') }}?time="+$data;
        });
        ...
        $(document).on("click","#select",function () {
            ...
            location.href = "{{url('agent/teamJou') }}?val="+val+"&user_id="+user_id+"&select_status="+select_status;
        });
