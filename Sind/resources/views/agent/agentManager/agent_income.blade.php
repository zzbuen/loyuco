...
<div class="layui-fluid main">
    ...
    <form method="post" action="{{url('agent/agent_income')}}">
        {{ csrf_field() }}
            ...
            <tbody>
                @foreach($profit_list as $item)
                    <tr>
                        ...
                        <td>{{$item['info']['parent_user_id']}}</td>
...
<script>
    layui.use(['form', 'layedit', 'laydate'], function() {
        ...
        $(".sorting").click(function(){
            ...
            location.href = '{{ url("/agent/agent_income") }}?agent_user_id={{ Request::input("agent_user_id") }}&?user_type={{ Request::input("order_sn") }}&user_id={{ Request::input("user_id") }}&column='+column+'&sort='+sort;
        })
