...
<div class="layui-fluid main">
    ...
    <form method="post" action="{{url('agent/agent_profit')}}">
        {{ csrf_field() }}
            ...
            <tbody>
                @foreach($profit_list as $item)
                    <tr>
                        ...
                        <td>{{$agent_info[$item['agent_user_id']]['info']['name']}}</td>
                        <td>{{$item['user_id']}}</td>
                        <td>{{$item['info']['bank_account_name']}}</td>
...
<script>
    layui.use(['form', 'layedit', 'laydate'], function() {
        ...
        $(".sorting").click(function(){
            ...
            location.href = '{{ url("agent/agent_profit") }}?order_sn={{Request::input('order_sn')}}&agent_user_id={{ Request::input("agent_user_id") }}&user_id={{ Request::input("user_id") }}&column='+column+'&sort='+sort;
        })
