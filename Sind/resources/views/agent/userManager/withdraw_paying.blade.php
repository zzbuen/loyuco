        ...
        <div class="layui-tab-content" style="">
            <div class="layui-tab-item layui-show">
                <div style="padding: 10px;border: 1px solid gainsboro;width: 100%;margin-left: -11px;">
                    ...
                    <form action="{{ url("agent/submit_excel")}}" id="inport_form"  method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
...
<script>
    layui.use(['form', 'layedit', 'laydate'], function() {
       ...
       $("#payment_excel").click(function () {
           window.open('{{ url("magent/payment_excel") }}');
           location.reload();
       })
        ...
        function payChange_status_ajax(withdraw_sn,status) {
            var ajax_url = "{{url("/agent/payChange_status_ajax")}}";
        ...
        $("#get_excel").click(function () {
            window.open('{{ url("agent/get_excel")}}?withdraw_type=1');
            location.reload();
        })
