...
<head runat="server">
    ...
    <style>
        ...
        table td, table th { padding: 0; text-align: center; color: #666; }
    ...
    <form id="form1" runat="server">
        <table id="zstable"  style="float: left;border-right: 1px solid rgba(155, 155, 155, 0.28)">
            @if($data)
                ...
                <thead>
                    <tr style="height: 2.5rem">
                        ...
                        @for($j=$heard_j;$j<$heard_num;$j++)
                            <th class="all_td border_bottm color_one" style="width: 10%" colspan="10">{{$header_name[$j]}}</th>
                        @endfor
                        <th class="all_td border_bottm color_one" colspan="10">号码分布</th>
                        @if($xing==0)
                            <th style="width: 6%" class="all_td border_bottm color_one" colspan="2" rowspan="2">大小形态</th>
                            <th style="width: 6%" class="all_td border_bottm color_one" colspan="2" rowspan="2">单双形态</th>
                            <th style="width: 7%" class="all_td border_bottm color_one" colspan="2" rowspan="2">升平降形态</th>
                            @else
                            <th style="" class="all_td border_bottm color_one" colspan="5" rowspan="2">大小形态</th>
                            <th style="" class="all_td border_bottm color_one" colspan="5" rowspan="2">单双形态</th>
                            <th style="" class="all_td border_bottm color_one" colspan="5" rowspan="2">升平降形态</th>
                        @endif
                    </tr>
                    {{--0-9显示start--}}
                    <tr style="height: 2.5rem">
                        ...
                        <tr class="show_border <?php if(($key+1)%5==0) echo 'border_bottm_5' ?>">
                            ...
                            @for($j=$start_j;$j<$number_length-1;$j++)
                                ...
                                @php
                                    if($xing=="0"){
                                        ...
                                        if($key!="0"){
                                            $shangyiqi = substr($data[$key-1]["result"],0,5);
                                        }else{
                                            $shangyiqi = 0;
                                        }
                                    }
                                    if($xing=="1"){
                                        $res = substr($value["result"],$j*3,2);
                                        $str = substr($value["result"],0,14);
                                        if($key!="0"){
                                            $shangyiqi = substr($data[$key-1]["result"],0,14);
                                        }else{
                                            $shangyiqi = 0;
                                        }
                                    }
                                    if($xing=="2"){
                                        $res = substr($value["result"],(5+$j)*3,2);
                                        $str = substr($value["result"],15);
                                        if($key!="0"){
                                            $shangyiqi = substr($data[$key-1]["result"],15);
                                        }else{
                                            $shangyiqi = 0;
                                        }
                                    }
                                    $shangyiqi_arr  = explode(",",$shangyiqi);
                                ...
                                @for($i=1;$i<11;$i++)
                                    ...
                                    @if($res == $i)
                                        ...
                                        @endphp
                                        {{--php数值记录end--}}
                                        <td class="<?php if($i==10) echo 'all_td'; ?>"><span class="layui-badge xian{{$j}}">{{$i}}</span></td>
                                    {{--没中奖start--}}
                                    @else
                                        @php
                                            $arr[$j][$i][0]++;
                                        ...
                                        @endphp
                                        {{--第九个的时候添加右边start--}}
                                        <td class="<?php if($i==10) echo 'all_td';?> yiloutiao{{$j}}{{$i}}{{$arr[$j][$i][7]}} <?php if(($key+1)%5==0) echo 'yiloutiao_5'.$j.$i ?>">
                                            <span class="yilou">
                                                {{$arr[$j][$i][0]}}
                                            </span>
                                        </td>
                            ...
                            @for($i=1;$i<11;$i++)
                                ...
                                @if(array_key_exists($i_show,$res_arr))
                                    ...
                                    @endphp
                                    @if($res_arr[$i_show]>=2)
                                        <td <?php if($i==10) echo 'class="all_td"';?>><span style="background: #BD3ED4!important;" class=" layui-badge layui-bg-cyan">{{$i}}</span></td>
                                    @else
                                        <td <?php if($i==10) echo 'class="all_td"';?>><span class="layui-badge layui-bg-green">{{$i}}</span></td>
                                    @endif
                                @else
                                    @php
                                        /*遗漏值++*/
                                    ...
                                    @endphp
                                    <td <?php if($i==10) echo 'class="all_td"';?>><span class="yilou ">{{$fenbu_arr[$i]}}</span></td>
                                @endif
                            @endfor
                            {{--号码分布end--}}
                            ...
                            @if($xing==0)
                                {{--大小形态--}}
                                @foreach($res_arr_all as $key=>$value)
                                    @if($value>5)
                                        <td class="<?php if($key==1)echo 'all_td' ?>">小</td>
                                        @else
                                        <td class="<?php if($key==1)echo 'all_td' ?>"> 大</td>
                                    @endif
                                @endforeach
                                {{--单双形态--}}
                                @foreach($res_arr_all as $key=>$value)
                                    @if($value%2==0)
                                        <td class="<?php if($key==1)echo 'all_td' ?> ">双</td>
                                    @else
                                        <td class="<?php if($key==1)echo 'all_td' ?>"> 单</td>
                                    @endif
                                @endforeach

                                {{--升平降形态冠亚军--}}
                            @if($shangyiqi!=0)
                                    @foreach($shangyiqi_arr as $key=>$value)
                                        @if($value=="")
                                            <td class="<?php if($key==1)echo 'all_td' ?> ">平</td>
                                            <td class="<?php if($key==1)echo 'all_td' ?> ">平</td>
                                        @else
                                            @if($res_arr_all[$key]>$shangyiqi_arr[$key])
                                                <td class="<?php if($key==1)echo 'all_td' ?>">升</td>
                                            @endif
                                            @if($res_arr_all[$key]==$shangyiqi_arr[$key])
                                                <td class="<?php if($key==1)echo 'all_td' ?> ">平</td>
                                            @endif
                                            @if($res_arr_all[$key]<$shangyiqi_arr[$key])
                                                <td class="<?php if($key==1)echo 'all_td' ?>">降</td>
                                            @endif
                                        @endif
                                    @endforeach
                                @else
                                    <td>平</td>
                                    <td class="all_td">平</td>
                            @endif
                                ...
                                @foreach($res_arr_all as $key=>$value)
                                    @if($value>5)
                                        <td class="<?php if($key==4)echo 'all_td' ?> ">小</td>
                                    @else
                                        <td class="<?php if($key==4)echo 'all_td' ?>"> 大</td>
                                    @endif
                                @endforeach
                                {{--单双形态--}}
                                @foreach($res_arr_all as $key=>$value)
                                    @if($value%2==0)
                                        <td class="<?php if($key==4)echo 'all_td' ?> ">双</td>
                                    @else
                                        <td class="<?php if($key==4)echo 'all_td' ?>"> 单</td>
                                    @endif
                                @endforeach
                            ...
                            @if($shangyiqi!="0")
                                    @foreach($shangyiqi_arr as $key=>$value)
                                        @if($value=="")
                                            <td class="<?php if($key==4)echo 'all_td' ?> ">平</td>
                                            <td class="<?php if($key==4)echo 'all_td' ?> ">平</td>
                                            <td class="<?php if($key==4)echo 'all_td' ?> ">平</td>
                                            <td class="<?php if($key==4)echo 'all_td' ?> ">平</td>
                                            <td class="<?php if($key==4)echo 'all_td' ?> ">平</td>
                                        @else
                                            @if($res_arr_all[$key]>$shangyiqi_arr[$key])
                                                <td class="<?php if($key==4)echo 'all_td' ?>">升</td>
                                            @endif
                                            @if($res_arr_all[$key]==$shangyiqi_arr[$key])
                                                <td class="<?php if($key==4)echo 'all_td' ?> ">平</td>
                                            @endif
                                            @if($res_arr_all[$key]<$shangyiqi_arr[$key])
                                                <td class="<?php if($key==4)echo 'all_td' ?> ">降</td>
                                            @endif
                                        @endif
                                    @endforeach
                                @else
                ...
                <tbody>
                    ...
                    <tr class="height40">
                        ...
                        @for($j=$start_j;$j<$number_length-1;$j++)
                            @for($i=1;$i<11;$i++)
                                <td rowspan="1" class="border_bottm color_one <?php if($i==10) echo 'all_td'; ?>">{{$arr[$j][$i][1]}}</td>
                            @endfor
                        @endfor

                        {{--号码分布平均总次数start--}}
                        @for($i=1;$i<11;$i++)
                            <td rowspan="1" class="border_bottm color_one <?php if($i==10) echo 'all_td'; ?>">{{$fenbu_total_arr[$i][1]}}</td>
                        @endfor
                        ...
                        @if($xing==0)
                            {{--大小形态--}}
                            @foreach($res_arr_all as $key=>$value)
                                <td class="<?php if($key==1)echo 'all_td' ?> border_bottm color_one"></td>
                            @endforeach
                            {{--单双形态--}}
                            @foreach($res_arr_all as $key=>$value)
                                <td class="<?php if($key==1)echo 'all_td' ?> border_bottm color_one"></td>
                        ...
                        @else
                            {{--大小形态--}}
                            @foreach($res_arr_all as $key=>$value)
                                <td class="<?php if($key==4)echo 'all_td' ?> border_bottm color_one"></td>
                            @endforeach
                            {{--单双形态--}}
                            @foreach($res_arr_all as $key=>$value)
                                <td class="<?php if($key==4)echo 'all_td' ?> border_bottm color_one"></td>
                    ...
                    <tr class="height40">
                        ...
                        @for($j=$start_j;$j<$number_length-1;$j++)
                            @for($i=1;$i<11;$i++)
                                <td class="border_bottm color_one <?php if($i==10)echo 'all_td';?>">
                                    @if($arr[$j][$i][2] == 0)
                                        {{$count_data}}
                                    @else
                    ...
                    <tr class="height40">
                        ...
                        @for($j=$start_j;$j<$number_length-1;$j++)
                            @for($i=1;$i<11;$i++)
                                <td class="border_bottm color_one <?php if($i==10)echo 'all_td';?>">{{$arr[$j][$i][3]}}</td>
                            @endfor
                        @endfor

                        {{--号码分布最大遗漏值start--}}
                        @for($i=1;$i<11;$i++)
                            <td class="border_bottm color_one <?php if($i==10)echo 'all_td';?>">{{$fenbu_total_arr[$i][3]}}</td>
                        @endfor
                        {{--号码分布最大遗漏值end--}}
                    ...
                    <tr class="height40">
                        ...
                        @for($j=$start_j;$j<$number_length-1;$j++)
                            @for($i=1;$i<11;$i++)
                                <td class="border_bottm color_one <?php if($i==10)echo 'all_td';?>">{{$arr[$j][$i][5]}}</td>
                            @endfor
                        @endfor
                        {{--号码分布最大连出值start--}}
                        @for($i=1;$i<11;$i++)
                            <td class="border_bottm color_one <?php if($i==10)echo 'all_td';?>">{{$fenbu_total_arr[$i][5]}}</td>
                        @endfor
                        {{--号码分布最大连出值end--}}
                ...
                <tbody>
                    ...
                    <tr style="height: 2.25rem">
                        ...
                        @for($j=$start_j;$j<$number_length;$j++)
                            @for($i=1;$i<11;$i++)
                                <td class="border_bottm color_two <?php if($i==10)echo 'all_td';?>">{{$i}}</td>
                            @endfor
                        @endfor
                        @if($xing==0)
                            <th style="width: 6%" class="all_td border_bottm color_one" colspan="2" rowspan="2">大小形态</th>
            ...
            @else
                ...
                <form class="layui-form" action="">
                    <div class="layui-form-item" pane="">
                        <div class="layui-input-block" style="margin: 0px;font-size: 1.3rem;color: gray">
                            暂无数据
                        </div>
                    </div>
                </form>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $(".link_number").click(function () {
            ...
            location.href = "/pk10?number="+$data+"&xing="+$color_greend;
        });
        ...
        $(".chaxun").click(function () {
            var $color_greend =$(".color_greend").attr("data");
            var $data = $("#test6").val();
            location.href = "/pk10?time="+$data+"&xing="+$color_greend;
        });
