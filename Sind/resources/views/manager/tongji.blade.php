...
<fieldset class="layui-elem-field layui-field-title">
    <legend>用户-{{$user_data["username"]}} - 数据统计</legend>
</fieldset>
            ...
            {{--<div class="layui-col-xs6">--}}
                {{--<div class="grid-demo grid-demo-bg1">--}}
                    {{--<div class="layui-form-item"  style="float: right;">--}}
                        ...
                        {{--<div class="layui-input-inline">--}}
                            {{--<input type="text" name="source_name" disabled="disabled" value="{{$data["rebate"]}}" lay-verify="required"  autocomplete="off" class="layui-input">--}}
            ...
            {{--<div class="layui-col-xs6">--}}
                {{--<div class="grid-demo grid-demo-bg1">--}}
                    {{--<div class="layui-form-item"  style="float: right;">--}}
                        ...
                        {{--<div class="layui-input-inline">--}}
                            {{--<input type="text" name="source_name" disabled="disabled" value="{{$data["wages"]}}" lay-verify="required"  autocomplete="off" class="layui-input">--}}
            ...
            {{--<div class="layui-col-xs6" >--}}
                {{--<div class="grid-demo">--}}
                    {{--<div class="layui-form-item" >--}}
                        ...
                        {{--<div class="layui-input-inline">--}}
                            {{--<input type="text" name="source_name" disabled="disabled" value="{{$data["activity"]}}" lay-verify="required"  autocomplete="off" class="layui-input">--}}
                        {{--</div>--}}
                    {{--</div>--}}
                {{--</div>--}}
            {{--</div>--}}
