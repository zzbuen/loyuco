...
<div class="layui-fluid main">
    ...
    <form method="post" action="{{url('/manager/user_recharge_detail')}}?user_id={{Request::input('user_id')}}">
        {{ csrf_field() }}
        ...
        <table class="layui-table">
            <thead>
                <tr>
                    ...
                    <th>用户账号</th>
                    <th>用户名</th>
                    <th class="{{ Request::get('column')=='trade_amount'?(Request::get('sort')=='asc'?'sorting_asc':'sorting_desc'):'sorting_both' }} sorting" sort="trade_amount">充值金额</th>
                    <th>手续费</th>
                    <th>状态</th>
                    <th>描述</th>
...
<script>
    layui.use(['form', 'layedit', 'laydate'], function() {
        ...
        $(".sorting").click(function(){
            ...
            location.href = '{{ url("manager/user_recharge_detail") }}?date_end={{ Request::input("date_end") }}&date_begin={{ Request::input("date_begin") }}&user_id={{ Request::input("user_id") }}&column='+column+'&sort='+sort;
        })
        @if ($errors->has('error'))
