...
<div class="layui-fluid main">
    <div class="layui-tab">
        ...
        <form method="post" action="{{url('manager/getOrder_chedan')}}" style="margin-top: 25px;">
            {{ csrf_field() }}
...
<script>
    layui.use(['form', 'layedit', 'laydate'], function() {
        ...
        $(document).on("click",".money_order",function () {
            ...
            location.href ='{{url("manager/getOrder_chedan")}}?order='+order+"&dingdanhao="+dingdanhao+"&yonghuming="+yonghuming+"&qihao="+qihao+"&game_id="+game_id;
        });
