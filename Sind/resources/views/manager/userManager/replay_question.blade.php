...
<div class="layui-fluid main">
    <form id="uploadForm" method="post" style="margin-top: 20px;" class="layui-form " action="">
        ...
        <div class="layui-form-item">
            <input type="hidden" name="user_id" value="{{$question_info['send_user_id']}}">
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <textarea name="huifu" id="huifu" placeholder="请输入内容" class="layui-textarea"></textarea>
            </div>
        </div>
        <div style="text-align: center" class="layui-form-item layui-form-text">
            <button id="submit_btn" class="layui-btn" type="button">提交</button>
        </div>
    </form>
</div>
...
<script>
    layui.use(['form', 'layedit', 'laydate'], function() {
       ...
       $("#submit_btn").click(function () {
           var huifu = $("#huifu").val().replace(/(^\s*)|(\s*$)/g,"");
           if(huifu==""){
               layer.msg("回复内容不可为空",{"icon":2})
               return false;
           }
