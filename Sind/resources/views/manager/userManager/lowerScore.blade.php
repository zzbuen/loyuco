...
<div class="layui-fluid main">
    <fieldset class="layui-elem-field layui-field-title">
        <legend>{{$user['username']}} - 下分</legend>
    </fieldset>
    <form class="layui-form layui-form-pane" action="">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">下分金额</label>
            <div class="layui-input-block">
                <input type="number" name="recharge" lay-verify="required" placeholder="请输入下分金额" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div style="width: 100%;text-align: center">
            <button class="layui-btn" lay-submit="" lay-filter="demo1">确认下分</button>
        </div>
    </form>
</div>
