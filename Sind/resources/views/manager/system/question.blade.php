...
<div class="layui-fluid main">
    ...
    <div style="width: 100%">
        <button id="add_question" class="layui-btn">+添加安全问题</button>
    </div>
    <div class="layui-form">
        <table class="layui-table">
            <thead>
            <tr>
                <th style="text-align: center">问题序号</th>
    ...
    layui.use(['form', 'layedit', 'laydate'], function() {
        ...
        $('#add_question').click(function () {
            layui.use('layer',function(){
                ...
                layer.prompt({ title: '添加安全问题',value: ''},function(value, index, elem){
                    var data = {question:value};
                    var url = '{{url("/manager/add_question")}}';
                    $.ajax({
                        type: "POST",
                        url: url,
                        data: data,
