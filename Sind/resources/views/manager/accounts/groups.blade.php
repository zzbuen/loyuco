        ...
        <table class="layui-table">
            ...
            @foreach($role_list as $item)
                <tr>
                    ...
                    <td>
                        <button class="layui-btn layui-btn-small config-btn {{ $item['id']==1?'layui-btn-disabled':'' }}" {{ $item['id']==1?'disabled':'' }} config_id="{{ $item['id'] }}">编辑</button>
                        <button class="layui-btn layui-btn-small destroy-btn {{ $item['id']==1?'layui-btn-disabled':'layui-btn-danger' }}" {{ $item['id']==1?'disabled':'' }} config_id="{{ $item['id'] }}">授权</button>
                    </td>
                </tr>
            @endforeach
            </tbody>
