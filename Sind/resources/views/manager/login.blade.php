            ...
            <div class="logo_box">
                ...
                <form method="post">
                    ...
                    <div class="input_outer">
                        ...
                        <input name="username" class="text" value="{{old("username")}}" style="transition: background-color 50000s ease-in-out 0s;color: #FFFFFF !important" type="text" placeholder="请输入账户">
                    </div>
                    <div class="input_outer">
                        <span class="us_uer"></span>
                        <input name="password" class="text" style="transition: background-color 50000s ease-in-out 0s;color: #FFFFFF !important; position:absolute; z-index:100;" value="{{old("password")}}" type="password" placeholder="请输入密码">
                    </div>
                    {{--<div class="input_outer">--}}
                        ...
                        {{--<img id="checkCode" style="width: 120px;height: 40px; position:absolute; z-index:100; right: 16px; top:1px;" src="{{ captcha_src("flat") }}" onclick="javascript:re_captcha();" />--}}
                    {{--</div>--}}
