...
<div class="layui-fluid main">
    ...
    <form method="post" action="{{url('manager/sum_fenhon.index')}}">
        {{ csrf_field() }}
        ...
        <div class="layui-col-md3" style="margin-top: -0.5%">
            <div class="info-box">
                ...
                <div class="info-box-content">
                    <span class="info-box-text">已发放分红总金额</span>
        ...
        <div class="layui-col-md3" style="margin-top: -0.5%">
            <div class="info-box">
                ...
                <div class="info-box-content">
                    <span class="info-box-text">搜索条件分红总金额</span>
                    <span class="info-box-number" style="color: dodgerblue">{{$sousuo_fenhon}}</span>
                </div>
            </div>
        </div>
    </form>
...
<script>
    layui.use(['form', 'layedit', 'laydate'], function() {
        ...
        $(document).on("click",".kj_time",function () {
            ...
            location.href = "{{url('manager/sum_fenhon.index') }}?time="+$data;
        });
