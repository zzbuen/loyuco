                    ...
                    <table class="layui-table">
                        ...
                        <tbody>
                            @foreach($all_data as $key=>$value)
                                <tr>
                                    <td class=" sorting" sort="daymoney">{{$value["user"]["username"]}}</td>
...
<script>
    layui.use(['form', 'layedit', 'laydate'], function() {
        ...
        $(document).on("click",".kj_time",function () {
            ...
            location.href = "{{url('manager/stat.user.index') }}?time="+$data;
        });
        ...
        $(document).on("click","#select",function () {
            ...
            location.href = "{{url('manager/stat.user.index') }}?val="+val+"&user_id="+user_id;
        });
