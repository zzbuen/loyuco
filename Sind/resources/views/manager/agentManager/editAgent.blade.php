...
<div  class="layui-everyday-list" id="lay_body">
    <div class="layui-fluid main">
        <form style="margin-top: 20px;" class="layui-form layui-form-pane" action="">
            ...
            <div class="layui-form-item">
                <label class="layui-form-label">代理邀请码</label>
                <div class="layui-input-inline">
                    <input type="text" id="invitation_num" name="invitation_num" value="{{$agent_list[0]['relation']['invitation_num']}}" lay-verify="required" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
...
<script>
    layui.use(['form', 'layedit', 'laydate'], function() {
        ...
        $("#modifyAgent_ajax").click(function () {
            ...
            var share = $("#share").val();
            var invitation_num = $("#invitation_num").val();
            var data = {user_id:user_id,share:share,invitation_num:invitation_num};

            $.ajax({
                type: "POST",
                url: "/manager/modifyAgent_ajax",
                data: data,
                dataType: "json",
                headers: {
