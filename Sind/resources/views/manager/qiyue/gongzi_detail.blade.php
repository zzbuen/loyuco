...
<div class="layui-fluid main">
    <form style="margin-top: 20px;margin-left: 100px" class="layui-form layui-form-pane" action="">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input disabled type="text" name="source_name" value="{{$data["wage_money"]}}" lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <label class="layui-form-label">上级代理名称:</label>
            <div class="layui-input-inline">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input disabled type="text" name="source_name" value="{{$data["wage"]["create_time"]}}" lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">人数要求:</label>
            <div class="layui-input-inline">
                <input disabled type="text" name="source_name" value="{{$data["wage"]["amount_num"]}}人" lay-verify="required" autocomplete="off" class="layui-input">
            </div>
            <label class="layui-form-label">日量要求:</label>
            <div class="layui-input-inline">
                <input disabled type="text" name="source_name" value="{{$data["wage"]["amount_day"]}}" lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">活跃金额:</label>
            <div class="layui-input-inline">
                <input disabled type="text" name="source_name" value="{{$data["wage"]["amount_money"]}}元" lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input disabled type="text" name="source_name" value="{{$data["wage"]["wage_ratio"]}}%" lay-verify="required" autocomplete="off" class="layui-input">
            </div>
            <label class="layui-form-label">应发工资:</label>
            <div class="layui-input-inline">
                <input disabled type="text" name="source_name" value="{{$data["wage_amount"]}}" lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        </div>
    </form>
</div>
