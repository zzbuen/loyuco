    ...
    <form class="layui-form layui-form-pane" action="" style="margin-left: 20%;margin-top: 20%">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline" style="width: 250px">
                <input type="tel" maxlength="2"  name="source_name" value="" lay-verify="required"   autocomplete="off" class="layui-input input15">
                <input type="tel" maxlength="2"  name="source_name" value="" lay-verify="required"  autocomplete="off" class="layui-input input15">
                <input type="tel" maxlength="2"  name="source_name" value="" lay-verify="required"  autocomplete="off" class="layui-input input15">
                <input type="tel" maxlength="2"  name="source_name" value="" lay-verify="required"  autocomplete="off" class="layui-input input15">
                <input type="tel" maxlength="2"  name="source_name" value="" lay-verify="required"  autocomplete="off" class="layui-input input15">
    ...
    layui.use(['form', 'layedit', 'laydate'], function() {
        ...
        $(document).on("click","#mondify_ajax",function () {
            ...
            for(var i=0;i<input15.length;i++){
                ...
                if(!reg.test(val)){
                    layer.msg("第"+(i+1)+"位的开奖数值，值不能为空且必须是正整数，且值必须是2位数，如果数字小于10请补0",{"icon":2});
                    break;
                }
                if(val>11){
                    layer.msg("第"+(i+1)+"位的开奖数值，值不能大于11哦亲",{"icon":2});
                    break;
                }
                if(val==0){
                    layer.msg("第"+(i+1)+"位的开奖数值，11选5游戏没0哦亲",{"icon":2});
                    break;
                }
                result+=val+",";
            }
