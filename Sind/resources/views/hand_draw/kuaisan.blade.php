    ...
    <form class="layui-form layui-form-pane" action="" style="margin-left: 20%;margin-top: 20%">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline" style="width: 250px">
                <input type="tel" maxlength="1"  name="source_name" value="" lay-verify="required"   autocomplete="off" class="layui-input input15">
                <input type="tel" maxlength="1"  name="source_name" value="" lay-verify="required"  autocomplete="off" class="layui-input input15">
                <input type="tel" maxlength="1"  name="source_name" value="" lay-verify="required"  autocomplete="off" class="layui-input input15">
            </div>
        </div>
    ...
    layui.use(['form', 'layedit', 'laydate'], function() {
        ...
        $(document).on("click","#mondify_ajax",function () {
            ...
            for(var i=0;i<input15.length;i++){
                ...
                if(!reg.test(val)){
                    layer.msg("请输入第"+(i+1)+"位的开奖数值，值不能为空且必须时正整数",{"icon":2});
                    break;
                }
                result+=val+",";
            }
